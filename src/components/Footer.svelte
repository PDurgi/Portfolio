...
>
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        ...
        <p><b class="pr-2">Email</b> pooja.durgi18@gmail.com</p>
        <p>
            <b class="pr-2">GitHub</b>
            <a href="https://github.com/PDurgi" target="_blank" class="text-violet-400"
                >Pooja Durgi<sup class=""
        ...
        <p>
            ...
            <a href="https://www.linkedin.com/in/poojadurgi/" target="_blank" class="text-violet-400"
                >Pooja Durgi<sup class=""
                    ><span class="text-xs scale-75 pl-0.5"
                        ><i
                            class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
